...
public class RobotMap {
	...
	// CAN INSTEAD OF PWM // probably all of these numbers are not quite correct
	// (CAN)
	public static final int shooterMotor = 4;
	public static final int pickupMotor = 5;
	public static final int feederMotor = 8; // also feeder is a bad name, what
												// does that mean?
	...
	/*
	 * 
	 * I have a Talon on ID 6 which should be for one of the climber motors, it
	 * has no code telling it to move I have a Talon on ID 7 which should be for
	 * one of the climber motors, it has no code telling it to move I have a
	 * Talon on ID 8 which should be for one of the hopper motors, it has no
	 * code telling it to move I have a Talon on ID 9 which should be for one of
	 * the hopper motors, it has no code telling it to move
	 * 
	...
	public static final int ltcLeftBumper = 5;
	public static final int ltcRightBumper = 6;
	public static final int leftTrigger = 7;
	public static final int rightTrigger = 8;
	public static final int ltcBackButton = 9;
	public static final int ltcStartButton = 10;
	public static final int ltcPressLeftStick = 100; // IDK what actual number
														// is
	public static final int ltcPressRightStick = 100; // IDK what actual number
														// is
	// analog ports
	...
	public static final int btnEmergencyReverse = 7; // btw this doesn't work in
														// conjuction with
														// running the
														// btnShooter
